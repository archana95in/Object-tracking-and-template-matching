...
imPath = 'C:\Users\Archana Narayanan\Desktop\DIP\Tracking ALgorithm\Template Matching\Dancer2\Dancer2\img'; imExt = 'jpg';
...
for m = 1:size(ImSeq,3)
    ...
    Foreground_Threshold = Foreground>50; % Foreground Image With Threshold
...
for i = 1:size(ImSeq,3)
    ...
    if(Area_Box)
        hold on;
        rectangle('Position', B_box,'EdgeColor','g');
        hold off;
    end
    drawnow;
end