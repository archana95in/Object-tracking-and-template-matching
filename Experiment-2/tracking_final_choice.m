rgbImage = imread('C:\Users\Archana Narayanan\Desktop\DIP\Tracking ALgorithm\Template Matching\Dancer2\Dancer2\img\0001.jpg');
comparison_Image = imread('C:\Users\Archana Narayanan\Desktop\DIP\Tracking ALgorithm\Template Matching\Dancer2\Dancer2\img\0150.jpg');
...
templateWidth = 40
templateHeight =188
template_I = imcrop(rgbImage, [150.5, 32.5, templateWidth, templateHeight]);
subplot(2, 2, 2);
imshow(template_I, []);
axis on;
...
[location] = tMatcher((rgbImage),(template_I));
axis on; 
hold on;

%%  Draw the rectangle for the template box
boxRect = [corr_offset(1), corr_offset(2),40,188]
...
rect1 = [corr_offset(1), corr_offset(2),40,188] 
rect2 = [166, 63,42,152];
intersectionArea = rectint(rect1,rect2);
unionArea = 40*188 + 42*152 - intersectionArea;
