rgbImage = imread('C:\Users\Archana Narayanan\Desktop\DIP\Tracking ALgorithm\Template Matching\Biker\Biker\img\0001.jpg');
comparison_Image = imread('C:\Users\Archana Narayanan\Desktop\DIP\Tracking ALgorithm\Template Matching\Biker\Biker\img\0142.jpg');
...
template_I = imcrop(rgbImage, [192, 82, templateWidth, templateHeight]);
subplot(2, 2, 2);
imshow(template_I, []);
axis on;
...
boxRect = [corr_offset(1), corr_offset(2),250,172]
...
rect1 = [corr_offset(1), corr_offset(2),250,172] 
rect2 = [374,84,17,19];
intersectionArea = rectint(rect1,rect2);
unionArea = 25*17 + 17*19 - intersectionArea;
